...
| E5-2 → E8 | ⬜ chưa | Kế: E5-2 `two-hop-route` (A-B-C, routeHops:1), E5-3 `insufficient-capacity` (payment fail, reason khớp ErrorCategory), E5-4 map ErrorCategory; rồi E6 test-kit. |

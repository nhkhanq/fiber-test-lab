...
| E8-1/3/4 → | ⬜ chưa (stretch) | E8-1 `expired-invoice` cần seeder trả invoice (hiện chỉ keysend) + link step→invoice — feature lớn hơn, hoãn. E8-3 event-driven (subscribe_store_changes), E8-4 multi-asset (RUSD) — stretch xa. |

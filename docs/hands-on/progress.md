...
| E8-3/4 → | ⬜ chưa (stretch xa) | E8-3 event-driven test-kit (`subscribe_store_changes` thay poll), E8-4 multi-asset (RUSD/xUDT). Còn lại phần lớn là stretch không bắt buộc. |

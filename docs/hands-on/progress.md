...
| E5 → E8 | ⬜ chưa | HẾT EPIC E4 (CLI). Kế: E5-1 `direct-channel` verify deterministic 3 run, E5-2 `two-hop-route`, E5-3 `insufficient-capacity`, E5-4 map ErrorCategory; rồi E6 test-kit. |

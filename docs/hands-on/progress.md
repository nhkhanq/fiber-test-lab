...
| E7 → E8 | ⬜ chưa | HẾT E6 (test-kit: setupScenario + expectPayment*/expectChannelState + examples). Kế: E7 docs & submission (scenario-catalog.md pin versions, README), E8 stretch scenarios (expired-invoice, peer-offline). |
